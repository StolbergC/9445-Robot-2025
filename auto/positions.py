...
blue_coral_intake_left_left = Pose2d.fromFeet(
    ...
    FIELD_WIDTH_FT
    - ROBOT_WIDTH_FT / 2 * CORAL_STATION_LEFT_ANGLE.sin()
...
blue_coral_intake_left_center = Pose2d.fromFeet(
    -ROBOT_WIDTH_FT / 2
    - 2 / 3 * CORAL_STATION_LENGTH_FT * CORAL_STATION_LEFT_ANGLE.cos()
    + ROBOT_WIDTH_FT * CORAL_STATION_LEFT_ANGLE.sin(),
    FIELD_WIDTH_FT
    - CORAL_STATION_LENGTH_FT * CORAL_STATION_LEFT_ANGLE.sin()
    - ROBOT_WIDTH_FT / 2 * CORAL_STATION_LEFT_ANGLE.cos(),
    CORAL_STATION_LEFT_ANGLE,
)

blue_coral_intake_left_right = Pose2d.fromFeet(
    ROBOT_WIDTH_FT / 2,
    FIELD_WIDTH_FT - CORAL_STATION_LENGTH_FT * CORAL_STATION_LEFT_ANGLE.sin() * 0.8,
    CORAL_STATION_LEFT_ANGLE,
)

blue_coral_intake_right_left = Pose2d.fromFeet(
    ROBOT_WIDTH_FT / 2 + 0.5,
    CORAL_STATION_X_LENGTH_FT,
    CORAL_STATION_LEFT_ANGLE,
)

blue_coral_intake_right_center = Pose2d.fromFeet(
    CORAL_STATION_Y_LENGTH_FT * CORAL_STATION_RIGHT_ANGLE.cos() + ROBOT_WIDTH_FT / 2,
